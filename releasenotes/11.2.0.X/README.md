...
- Promover os seguintes packages para o feed de produto:
  ...
  <br/>_Nota: Como a funcionalidade de 'import' para o 'global feed' no portal DevOps não está a funcionar, podem, excessionalmente, encontrar estes packages no feed **private-elevation-fw**_
